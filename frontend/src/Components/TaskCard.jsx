...
const TaskCard = ({ title, description, status, taskId, createdAt, completedAt }) => {
  ...
  return (
    <>
    <div className='min-w-[360px] min-h-[400px] border-2 border-blue-600 text-black flex flex-col justify-between py-6 px-5 rounded-md'>
      <div>
    ...
    <TaskModal isOpen={isModalOpen} closeModal={closeModal} taskId={taskId} />
    </>
  )
}
