    ...
    <>
    {
            ...
            }
            {
                ...
                <div className=" pt-4 flex gap-6">
                  <Link to='/dashboard' className=" relative text-2xl text-white bg-blue-600 flex justify-center 
                  ...
                  <button
                    onClick={openModal}
                    className="text-2xl text-white px-4 py-2 bg-blue-600 w-fit rounded-md hover:bg-blue-700 flex 
